...
export function CredentialsManager({ clientId, clientEmail, hasPortalAccess }: CredentialsManagerProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>View login information or reset the password for this client</DialogDescription>
        </DialogHeader>
          ...
          {!credentials ? (
              ...
              <div className="bg-muted p-4 rounded-lg space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <div className="space-y-1 flex-1">
                    ...
                    <p className="text-sm text-muted-foreground font-mono">{clientEmail}</p>
                  </div>
                </div>
            ...
            <>
              <Alert>
                ...
                <AlertDescription>
                  A new temporary password has been generated. Share these credentials with the client securely.
                </AlertDescription>
              </Alert>
              ...
              <Alert>
                <AlertDescription className="text-sm">
                  The client should change this temporary password after their first login.
                </AlertDescription>
              </Alert>
